...
/**
 * Renders messages to a Word (.docx) file buffer suitable for export.
 * Converts the plain-text rendering into structured Word document paragraphs.
 */
export async function renderMessagesToDocx(
	messages: Message[],
	tools: Tools = [],
	columns?: number,
): Promise<Buffer> {
	const plainText = await renderMessagesToPlainText(messages, tools, columns)
